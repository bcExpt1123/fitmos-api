    ...
    'routes' => [
        [
            ...
            'exclude' => [
                ...
                'surveys.*',
                'api/surveys/active',
                'api/surveys/inactive',
                'shortcodes.*',
                'api/shortcodes/get-size',
                'api/shortcodes/{id}/disable',
                'api/shortcodes/{id}/restore',
                'api/countries',
                'companies.*',
                'api/companies/{id}/disable',
                ...
                'customers.show',
                'reports*',
                'social-reports.index',
                'social-reports.delete',
                'api/social-reports/{id}/complete',
                'api/social-reports/{id}/restore',
                'api/sync*',
                'api/services*',
                ...
                'subscriptions.index',
                'api/survey-items*',
                'survey-reports.index',
                'api/survey-reports/view',
                'api/survey-reports/export',
                'api/users',
                'roles*',
                'oauth*',
                'chat/verify-local',
