...
Route::resource('survey-reports', 'SurveyReportController')->middleware('auth:api');
Route::post('survey-roports/view', 'SurveyReportController@view')->middleware('auth:api');
