...
Route::post('customers/push-notification-token', 'CustomerController@pushNotificationToken')->middleware('auth:api');
...
Route::resource('likes', 'LikeController')->only(['store','destroy','index'])->middleware('auth:api');
