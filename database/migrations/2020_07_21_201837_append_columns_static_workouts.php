...
class AppendColumnsStaticWorkouts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('static_workouts', function (Blueprint $table) {
            ...
            $table->enum('calentamiento_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('con_content_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('sin_content_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('strong_male_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('strong_female_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('fit_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('cardio_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('extra_sin_timer_type',['amrap','for_time','tabata'])->nullable();
            ...
            $table->enum('activo_timer_type',['amrap','for_time','tabata'])->nullable();
